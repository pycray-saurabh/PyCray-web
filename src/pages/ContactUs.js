            ...
            <form className='contactform'>
              <div className='forminput'>
                <div className='sec'>
                  ...
                  <input className='contactInput' defaultValue={'Sejal'} type='text' required></input>
                </div>
                ...
                <div className='sec'>
                  ...
                  <input className='contactInput' defaultValue={'yes@company.com'} type='text' required></input>
                </div>
                ...
                <div className='sec'>
                  ...
                  <input className='contactInput' defaultValue={'123456789'} type='text' required></input>
                </div>
              ...
              <div>
                <button className='ourConcept contactButton'>Send message</button>
              </div>
            </form>
          </div>
